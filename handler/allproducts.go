...
func (h *allProductHandler) GetProductListByName(c *gin.Context) {
	name_product := c.Param("name_product")

	b, err := h.allproductsService.FindByNameProductList(name_product)
	...
	var booksResponse []allproducts.AllProductResponse
	for _, b := range b {
